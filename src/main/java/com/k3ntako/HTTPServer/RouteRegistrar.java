...
public class RouteRegistrar {
  ...
  public RouteRegistry registerRoutes() throws Exception {
    ...
    routeRegistry.registerRoute("POST", "/reminders", (RequestInterface req) -> new Reminders(reminderIO).post(req));
    routeRegistry.registerRoute("GET", "/reminders/:id", (RequestInterface req) -> new Reminders(reminderIO).get(req));
    routeRegistry.registerRoute("PUT", "/reminders/:id", (RequestInterface req) -> new Reminders(reminderIO).put(req));
    routeRegistry.registerRoute("DELETE", "/reminders/:id", (RequestInterface req) -> new Reminders(reminderIO).delete(req));
